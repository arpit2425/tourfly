      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Unable to log out! Try again later ');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJwaXQyNDI1IiwiYSI6ImNrNm52OGh0bzBzaHgzanJ1NGt4Ym5jYW8ifQ.k0QDOUSvqR6OrbWR0xOg7A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    center: [80.332796, 26.4248952],
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_VEAoyMNl6476FFME4cPMc4lY00nVeeEgWm');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.querySelector('#passwordConfirmS').value;
    ...
    (0, _signup.signup)(name, email, password, passwordConfirm); // login(email, password);
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13383" + '/');
